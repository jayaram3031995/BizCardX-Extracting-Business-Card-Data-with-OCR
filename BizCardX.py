...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Jai@0123', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\91739\\OneDrive\\Documents\\Business-Card-Template.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Jayaram",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Jayaram*!"""})
...
selected = option_menu(None, ["Home", "Upload & Modify", "Delete"],
                       ...
                       styles={"nav-link": {"font-size": "35px", "text-align": "centre", "margin": "-3px",
                               ...
                               "nav-link-selected": {"background-color": "#94328b"}})

# HOME MENU
if selected == "Home":
    col1, col2 = st.columns(2)
    with col1:
        st.image(Image.open("C:\\Users\\91739\\OneDrive\\Documents\\Business-Card-Template.jpg"), width=500)
